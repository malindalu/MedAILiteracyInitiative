...
export const programs = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "A community workshop being developed in partnership with the Tzu Chi Foundation, designed for older adults anxious but also curious about navigating an increasingly AI-saturated world. Rather than technical depth, this program prioritizes practical wisdom: understanding what AI can and cannot do, using AI to increase day-to-day efficiency, and knowing when to trust — and when not to trust — an AI system. This workshop will be taught in Mandarin with cultural awareness of what Asian members tend to think and fear about technology.",
      topics: [
        ...
        "How to use AI to translate, summarize, write, and visualize effectively",
        "How to prompt engineer for better results — with examples relevant to older adults",
